...
const Header = () => {
  ...
  const curent_user = async()=>{
    ...
    console.log(info_user) 
      ...
      console.log("api is not working", eror)
    }
  }
  useEffect(()=>{
    curent_user()
    ...
    <div id="collapseMenu"
      ...
      <ul
        ...
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
          <Link  to='/home' class='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Home</Link>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
          <Link to='/about' class='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>About</Link>
        </li>
        <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'><a href="/user"
            class='hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]'>User</a>
        </li>
